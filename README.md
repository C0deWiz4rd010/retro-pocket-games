...
### A pocket arcade in your browser — 55 retro games, one installable PWA.
...
**Retro Pocket** is a mobile-first, offline-capable web platform that bundles **55 classic
...
- **55 games across 8 categories** — the canon (Snake, Tetris, Pong, Breakout, Asteroids,
