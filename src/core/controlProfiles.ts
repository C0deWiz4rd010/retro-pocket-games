...
export const CONTROL_PROFILES = {
  grid: base({
    ...
    pointerMode: 'none',
    primaryActions: [{ action: 'a', label: 'ctl.a' }],
    hints: ['Move', 'Action'],
  }),
  falling: base({
    preset: 'falling',
    ...
    pointerMode: 'none',
    primaryActions: [
      { action: 'a', label: 'ctl.cycle' },
      { action: 'b', label: 'ctl.drop' },
    ],
  ...
  drag: base({
    ...
    pointerMode: 'drag',
    primaryActions: [{ action: 'a', label: 'ctl.launch' }],
    hints: ['Drag', 'Action'],
  }),
  shooter: base({
    preset: 'shooter',
    ...
    pointerMode: 'drag',
    primaryActions: [{ action: 'a', label: 'ctl.fire' }],
    hints: ['Move', 'Fire'],
  }),
  vector: base({
    preset: 'vector',
    ...
    pointerMode: 'none',
    primaryActions: [
      { action: 'a', label: 'ctl.thrust' },
      { action: 'b', label: 'ctl.fire' },
    ],
...
const explicit: Record<string, ControlProfile> = {
  ...
  sokoban: { ...CONTROL_PROFILES.grid, primaryActions: [{ action: 'a', label: 'ctl.a' }, { action: 'b', label: 'ctl.undo' }] },
  ...
  pinball: base({
    ...
    pointerMode: 'none',
    primaryActions: [
      { action: 'a', label: 'ctl.left' },
      { action: 'b', label: 'ctl.right' },
    ],
    hints: ['Flippers'],
  }),
};
